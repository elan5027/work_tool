...
for filename in os.listdir(directory):
    ...
    if filename.endswith(".json"):  # JSON 파일만 처리
        ...
        with open(file_path, 'r', encoding='utf-8') as file:
            ...
            modify_name = file_name[0:-1]+'0_AI.json'
            print(modify_name)
            modify_path = os.path.join(DIR, 'internal_wav', 'json', modify_name)
            ...
            with open(modify_path, 'r', encoding='utf-8') as modify_file:
                ...
                modify_data['audio_inside_id'] = file_name[0:-1]+'0'
                modify_data['audio_inside_file_name'] = file_name[0:-1]+'0.wav'
                modify_data['audio_inside_timestamp_start'] = _start
                modify_data['audio_inside_timestamp_end'] = _end
